...
def test_get_notifications_seeding(client, mock_firebase, mock_jwt_decode, auth_headers):
...
def test_get_notifications_existing(client, mock_firebase, mock_jwt_decode, auth_headers):
...
def test_mark_notification_as_read(client, mock_firebase, mock_jwt_decode, auth_headers):
    ...
    mock_firebase.update_document.assert_called_with("notifications", "notif-1", {"read": True})
