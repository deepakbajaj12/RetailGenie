...
class EmailUtils:
    ...
    def send_feedback_notification(
        self, product_id: str, user_email: str, rating: int, comment: str
    ) -> bool:
        """
    ...
    def send_low_stock_alert(
        self, product_id: str, product_name: str, current_stock: int
    ) -> bool:
        """
    ...
    def send_order_confirmation(
        self, user_email: str, order_id: str, order_details: dict
    ) -> bool:
        """
