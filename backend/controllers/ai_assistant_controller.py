...
class AIAssistantController:
    ...
    def process_voice_command(self, audio_file, user_id, language='en'):
        ...
        try:
            ...
            if response.get('generate_speech', False):
                response['audio_response'] = self._generate_speech(response['text'], language)
    ...
    def find_product_substitutes(self, product_id, preferences=None):
        ...
        try:
            ...
            original_product = self.firebase.get_document(self.products_collection, product_id)
    ...
    def optimize_coupons(self, user_id, cart_items):
        ...
        try:
            ...
            total_savings = sum(coupon.get('savings', 0) for coupon in optimized_coupons)
            ...
            return {
                ...
                'savings_percentage': (total_savings / cart_total * 100) if cart_total > 0 else 0
            }
        except Exception as e:
    ...
    def calculate_sustainability_score(self, cart_items):
        ...
        try:
            ...
            return {
                ...
                'environmental_impact': self._calculate_environmental_impact(cart_items),
    ...
    def _analyze_intent(self, message):
        ...
        elif any(word in message_lower for word in ['substitute', 'alternative', 'replace', 'similar']):
            return 'product_substitute'
        elif any(word in message_lower for word in ['price', 'cost', 'how much', 'expensive']):
            return 'price_inquiry'
        elif any(word in message_lower for word in ['where', 'location', 'aisle', 'section']):
            return 'store_navigation'
        elif any(word in message_lower for word in ['coupon', 'discount', 'deal', 'offer']):
    ...
    def _extract_search_terms(self, message):
        ...
        stop_words = {'i', 'am', 'looking', 'for', 'need', 'want', 'find', 'search', 'the', 'a', 'an'}
